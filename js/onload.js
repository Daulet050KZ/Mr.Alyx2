...
window.onload = function() {
	const images = [
		'url("e/img/background/back-1.jpg")', // /Mr.Alyx2/img/background/back-1.webp
		'url("e/img/background/back-2.jpg")', // /Mr.Alyx2/img/background/back-2.webp
		'url("e/img/background/back-3.jpg")', // /Mr.Alyx2/img/background/back-3.webp
		];
